...
#Read the sheet 
df <- read_excel('/home/abhishekh/Downloads/DNA_Prt_Strand_variant.xlsx')
...
file_path <- "DNA_Prt_Strand_Variant_MutDNA.xlsx"
...
data = read_excel("DNA_Prt_Strand_Variant_MutDNA_True.xlsx")
...
# Write in local 
# Specify the file path and name for the Excel file
file_path <- "DNA_Prt_Strand_Variant_MutDNA_True_SNP.xlsx"
