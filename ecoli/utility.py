...
def return_generation_grouped_dataframe(data, column_name: str, gen_cut_off:int, cut_off_string1:str, cut_off_string2:str):
    ...
    esm_score_median = data.groupby(["generation_number", "mutator"])[column_name].median()
